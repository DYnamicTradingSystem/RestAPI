...
app.get('/prices', (req, res) => {
	cli.emit('load',{"filename":"liveprices.js"});
...
app.get('/symbols', (req, res) => {
	//var r = send { "method":"GET", "resource":"/trading/get_instruments" };
	
	//@CR I dont know how to get that result into a Variable...
	cli.emit('send', { "method":"GET", "resource":"/trading/get_model", "params": { "models":["Offer"] } });
